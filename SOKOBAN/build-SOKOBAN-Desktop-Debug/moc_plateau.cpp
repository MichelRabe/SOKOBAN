...
QT_MOC_LITERAL(1, 8, 23), // "signalerVictoireANiveau"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "Plateau\0signalerVictoireANiveau\0"
};
...
void Plateau::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalerVictoireANiveau(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Plateau::signalerVictoireANiveau)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Plateau::signalerVictoireANiveau()
{
